resource datadog_monitor "aggregator_not_running" {
  ...
  message = templatefile("${path.module}/../../dd-monitor-message.tmpl", {environment: var.environment, aggregator: "Aggregator", description: "Aggregator not running"})
...
resource datadog_monitor "aggregator_high_mem" {
  ...
  message = templatefile("${path.module}/../../dd-monitor-message.tmpl", {environment: var.environment, aggregator: "Aggregator", description: "Aggregator high memory"})
...
resource datadog_monitor "aggregator_high_cpu" {
  ...
  message = templatefile("${path.module}/../../dd-monitor-message.tmpl", {environment: var.environment, aggregator: "Aggregator", description: "Aggregator high CPU"})
...
resource datadog_monitor "aggregator_high_errors" {
  ...
  message = templatefile("${path.module}/../../dd-monitor-message.tmpl", {environment: var.environment, aggregator: "Aggregator", description: "Aggregator high errors"})
...
resource datadog_monitor "aggregator_high_restarts_long" {
  ...
  message = templatefile("${path.module}/../../dd-monitor-message.tmpl", {environment: var.environment, aggregator: "Aggregator", description: "Aggregator high restarts (long)"})
