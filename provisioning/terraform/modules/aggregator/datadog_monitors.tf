resource datadog_monitor "aggregator_not_running" {
  ...
  message = templatefile("${path.module}/../../dd-monitor-message.tmpl", {environment: var.environment, description: "Aggregator not running"})
...
resource datadog_monitor "aggregator_high_mem" {
  ...
  message = templatefile("${path.module}/../../dd-monitor-message.tmpl", {environment: var.environment, description: "Aggregator high memory"})
...
resource datadog_monitor "aggregator_high_cpu" {
  ...
  message = templatefile("${path.module}/../../dd-monitor-message.tmpl", {environment: var.environment, description: "Aggregator high CPU"})
...
resource datadog_monitor "aggregator_high_errors" {
  ...
  message = templatefile("${path.module}/../../dd-monitor-message.tmpl", {environment: var.environment, description: "Aggregator high errors"})
